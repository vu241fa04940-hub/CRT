"""
URL configuration for ai_learning_path project.
...
urlpatterns = [
    ...
    # Auth paths with templates in students/
    ...
    path('password-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='students/password_reset_confirm.html'), name='password_reset_confirm'),
